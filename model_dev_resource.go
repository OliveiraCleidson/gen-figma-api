...
// checks if the DevResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DevResource{}
...
func (o DevResource) MarshalJSON() ([]byte, error) {
...
func (o DevResource) ToMap() (map[string]interface{}, error) {
...
func (o *DevResource) UnmarshalJSON(data []byte) (err error) {
	...
	varDevResource := _DevResource{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDevResource)

	if err != nil {
		return err
	}

	*o = DevResource(varDevResource)

	return err
}

type NullableDevResource struct {
	value *DevResource
	isSet bool
}

func (v NullableDevResource) Get() *DevResource {
	return v.value
}

func (v *NullableDevResource) Set(val *DevResource) {
	v.value = val
	v.isSet = true
}

func (v NullableDevResource) IsSet() bool {
	return v.isSet
}

func (v *NullableDevResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDevResource(val *DevResource) *NullableDevResource {
	return &NullableDevResource{value: val, isSet: true}
}

func (v NullableDevResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDevResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
